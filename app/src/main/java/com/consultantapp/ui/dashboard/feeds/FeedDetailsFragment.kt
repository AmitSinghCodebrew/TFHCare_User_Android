...
import com.consultantapp.databinding.FragmentFeedDetailsBinding
...
class FeedDetailsFragment : DaggerFragment() {
    ...
    override fun onCreateView(
        ...
        if (rootView == null) {
            binding =
                DataBindingUtil.inflate(inflater, R.layout.fragment_feed_details, container, false)
    ...
    private fun initialise() {
        ...
        if (userRepository.isUserLoggedIn() && isConnectedToInternet(requireContext(), true)) {
    ...
    private fun setData() {
        ...
        binding.tvDate.text =
            DateUtils.dateTimeFormatFromUTC(DateFormat.DATE_FORMAT_SLASH_YEAR, details?.created_at)
